...
public class form_pembeli extends javax.swing.JFrame {
    ...
    private void btnUbahActionPerformed(java.awt.event.ActionEvent evt) {
        try {
            ...
            java.sql.Connection connec = (Connection) conn;
    ...
    private void btnTambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTambahActionPerformed
        ...
        id_pembeli = fieldID.getText();
        nama_pembeli = fieldNama.getText();

        try {
            // nama kolom harus sama dengan yang di database
            String sql = "INSERT INTO pembeli (id_pembeli, nama_pembeli) VALUES(?,?)";
